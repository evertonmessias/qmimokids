...
<?php
	wp_enqueue_style('stilos', '/wp-content/plugins/qmimokids/assets/qmimokids.css');
	wp_enqueue_script('scripts', '/wp-content/plugins/qmimokids/assets/qmimokids.js');
}
...
{
	add_submenu_page('options-general.php', 'Sobre QMimoKids', 'Sobre QMimoKids', 'edit_posts', 'about', 'function_about', 10);
}
...
{
	include ABSPATH . '/wp-content/plugins/qmimokids/includes/about.php';
}
